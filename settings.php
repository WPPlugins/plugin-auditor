...
?>
    ...
    */
    function render() {
        ...
        <button class="button button-secondary"><a class="no-style" href="#" onClick ="$('#main-table').tableExport({type:'excel',escape:'false', tableName:'Plugin Auditor', ignoreColumn: [4]});"><?php _e( 'Export data to Excel', 'plugin_auditor' ); ?></a></button>
        <button class="button button-secondary"><a class="no-style" href="#" onClick ="$('#main-table').tableExport({type:'csv',escape:'false', tableName:'Plugin-Auditor', ignoreColumn: [4]});"><?php _e( 'Export data to CSV', 'plugin_auditor' ); ?></a></button>
